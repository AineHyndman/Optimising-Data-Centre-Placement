        ...
        <div className="flex flex-col items-center justify-center mt-16 max-w-[700px] mx-auto text-center">
          ...
          <div className="w-full grid grid-cols-3 gap-4 mb-10">
            <div className="bg-[#1a1d24] border border-[#2a2d35] rounded-lg p-5 text-left" style={{
              ...
              <div className="text-[#4A90E2] text-lg font-bold mb-1">1.</div>
              <div className="text-sm font-bold text-white mb-1">Upload</div>
              <div className="text-xs text-[#888]">Import a cluster plan JSON file generated by the placement optimiser.</div>
            </div>
            <div className="bg-[#1a1d24] border border-[#2a2d35] rounded-lg p-5 text-left" style={{
              border: "1px solid #5d9bffaa",
              boxShadow: "0 0 12px 3px #3B82F644, 0 0 24px 6px #3B82F622, inset 0 0 16px 2px #3B82F620",
            }}>
              <div className="text-[#4A90E2] text-lg font-bold mb-1">2.</div>
              <div className="text-sm font-bold text-white mb-1">Inspect</div>
              <div className="text-xs text-[#888]">Browse suites, view rack types and power heatmaps, and make manual edits.</div>
            </div>
            <div className="bg-[#1a1d24] border border-[#2a2d35] rounded-lg p-5 text-left" style={{
              border: "1px solid #5d9bffaa",
              boxShadow: "0 0 12px 3px #3B82F644, 0 0 24px 6px #3B82F622, inset 0 0 16px 2px #3B82F620",
          ...
          <p className="text-[#555] text-xs mt-3">Accepts .json files from the placement optimiser</p>
        </div>
      )}
